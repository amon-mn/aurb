...
class SidewalksPage extends StatefulWidget {
  final String tipo;
  const SidewalksPage({super.key, required this.tipo});

  @override
  _SidewalksPageState createState() => _SidewalksPageState();
}
              ...
              Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    MyDropdownFormField(
                      selectedValueNotifier: selectedSidewalk,
                      itemsList: itemListSidewalk,
                      onChanged: (value) {
                        setState(() {
                          selectedSidewalk.value = value!;
                        });
                      },
                    ),
                    SizedBox(height: 24),
                            ...
                            child: MyButton(
                              ...
                              onTap: () {
                                UserNotification notification =
                                  ...
                                  tipo: widget.tipo,
                                  natureza: selectedSidewalk.value,
